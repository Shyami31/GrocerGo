        ...
        <div className={styles['wrapper']}>
            <div className={styles['hero']}>
                <div className={styles['hero-text']}>
                    <h1>Order Number: 65XY23 arriving in <span>20</span> minutes</h1>
                    <p>Order is being packed in our nearest GrocerGo. Store</p>
            ...
            <section>
                <div className={'heading-wrapper'}>
                    <h1 className={'heading'}>Shop More</h1>
                </div>
                <Categories/>
            </section>
            <section>
                <div className={'heading-wrapper'}>
                    <h1 className={'heading'}>Shop Again</h1>
                </div>
